...
namespace SR46_2021_POP2022
{
    class Config
    {
        ...
        public static readonly string CONNECTION_STRING = @"Data Source=LAPTOP-SC9RDVNE;Initial Catalog=POPsr462021;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
        ...
        //public static readonly string languagesFilePath = @"../../Resources/languages.bin";
